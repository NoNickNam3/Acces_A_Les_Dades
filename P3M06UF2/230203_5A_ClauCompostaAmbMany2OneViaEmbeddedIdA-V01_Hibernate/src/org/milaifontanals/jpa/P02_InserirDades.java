...
public class P02_InserirDades {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Exemple de que podem crear províncies via 2 constructor diferents
            pr = new Provincia(pa, "B", "Barcelona");
            em.persist(pr);
            pr = new Provincia(pa, "L", "Lleida");
            em.persist(pr);
            pr = new Provincia(new ProvinciaId(pa, "T"), "Tarragona");
            em.persist(pr);
            pr = new Provincia(new ProvinciaId(pa, "GI"), "Girona");
            em.persist(pr);
