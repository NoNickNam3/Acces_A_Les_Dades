...
//    Les dues anotacions anteriors obligarien que allà on s'incrustés la classe
//    Tutoria, tutor1 sempre contingués valor i aixo pot no interessar sempre
    @Column(length = 40)
    private String tutor1;      // Obligatori i amb contingut

    @Column(columnDefinition = "varchar(40) check(length(tutor2)>0)")
