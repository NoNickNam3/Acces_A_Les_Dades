...
public class P03_MostrarDades {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String consulta = "select pa.codi, pa.nom, pr.provinciaId.provCodi, pr.nom ";
            consulta = consulta + "from Pais pa left join Provincia pr on pa.codi = pr.provinciaId.paisCodi ";
