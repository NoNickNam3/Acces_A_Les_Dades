 ...
 * @author Usuari
 */
public class ClauIdentity2ViaXml {
    Integer codi;
    String descripcio;

    protected ClauIdentity2ViaXml() {
    }

    public ClauIdentity2ViaXml(String descripcio) {
    ...
    public boolean equals(Object obj) {
        ...
        final ClauIdentity2ViaXml other = (ClauIdentity2ViaXml) obj;
