...
public class AgendaTallers implements Serializable {
    ...
    // Camp codiTaller ha de contenir sempre el valoir
    // del codi del taller apuntat pel camp "taller"
    ...
    private void setMomentInici(Calendar momentInici) {
        ...
        this.momentInici = (Calendar)momentInici.clone();
    }
...
//            return false;
//        }
        if (!Objects.equals(this.taller, other.taller)) {
            return false;
        }
